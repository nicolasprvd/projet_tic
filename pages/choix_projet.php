...
<br><br>
  ...
  if($data == null) {
    ?>
    <input type="submit" name="btn_submit_validate" value="Valider" <?php echo isset($_SESSION['btn_clicked']) ? $_SESSION['btn_clicked'] : ''; ?>/>
  <?php
  }else {
    //Si la personne est rattachée au projet correspondant
    ?>
      <input type="submit" name="btn_submit_retract" value="Se rétracter" <?php echo isset($_SESSION['btn_clicked']) ? $_SESSION['btn_clicked'] : ''; ?> />
  <?php
  } ?>
    </form>
